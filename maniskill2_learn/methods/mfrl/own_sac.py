...
class OWN_SAC(BaseAgent):
    def __init__(
        ...
        orig_buffer_updates=1,
        **kwargs
    ):
        super(OWN_SAC, self).__init__()
    ...
    def update_parameters(self, memory, updates, rollout, *args, **kwargs):

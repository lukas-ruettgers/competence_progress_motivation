...
class ActorCriticBase(ExtendedModule):
    ...
    def forward(self, obs, actions=None, **kwargs):
        ...
        if isinstance(feature, dict) and "aux_loss" in feature.keys():  # auxiliary backbone self-supervision
            assert (
...
class DiscreteActor(ActorCriticBase):
    def __init__(
        ...
        **kwargs
        ...
        ), "If you are training over discrete action space, you need ContinuousActor"

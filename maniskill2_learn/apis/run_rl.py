...
if __name__ == "__main__":
    ...
    # NOTE (Lukas): Deactivate n_goal_points for TurnFaucet-v0 and StackCube-v0
    n_goal_envs = ["PickSingleYCB-v0", "PickSingleEGAD-v0", "PickCube-v0"]
    if cfg.env_cfg.env_name not in n_goal_envs and cfg.env_cfg.n_goal_points is not None:
